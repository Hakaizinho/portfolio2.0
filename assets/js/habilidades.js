...
const dataInicio = [
                    (new Date(2023, 02, 8)).getTime(), // 0
                    (new Date(2023, 02, 15)).getTime(), // 1
                    (new Date(2023, 03, 1)).getTime(), // 2
                    (new Date(2023, 04, 1)).getTime(), // 3
                    (new Date(2022, 05, 1)).getTime(), // 4
                    (new Date(2022, 05, 1)).getTime(), // 5
